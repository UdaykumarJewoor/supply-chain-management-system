  ...
  return (
    <div className="main-content">
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <div>
          <h1 style={{ fontSize: '2rem', fontFamily: 'var(--font-display)', marginBottom: '0.25rem' }}>Procurement & Buying</h1>
        ...
        <div style={{ display: 'flex', gap: '0.75rem' }}>
          {activeTab === 'orders' ? (
            ...
            <button className="btn btn-primary" onClick={() => setIsCreateSupplierOpen(true)}>
              ...
              <tbody>
                {suppliers.map((supplier) => (
                  <tr key={supplier.name}>
                    ...
                    <td style={{ fontSize: '0.85rem', color: 'hsl(var(--text-muted))' }}>{supplier.address || '—'}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        <div className="modal-overlay">
          <form className="modal-content" style={{ maxWidth: '650px' }} onSubmit={handleSubmitPO}>
            <div className="modal-header">
              ...
              <button type="button" className="modal-close" onClick={() => setIsCreatePoOpen(false)}>×</button>
            </div>
